...
for negative_type in NONE MEDIAN
do
    for lmbd_region_corr_weight in 1 10
    do
        #
        # PRE-TRAINING
        #
        ...
        # Create logging name
        pretrain_run_id="$(date +"%y%m%d%H%M%S")-pretrain-${pretrain_type}-N${negative_type}-RG${lmbd_region_corr_weight}-PA"
