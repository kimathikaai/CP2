...
# Use a learnable lmbd

# NO PRED, NO SYM, AVGPOOL, BRANCH COORD
for pretrain_type in PROPOSED_V2
do
    for lmbd_coordinate in 1 0 0.25 0.75
    do
        #
